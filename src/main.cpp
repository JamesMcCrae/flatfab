...
int main(int argc, char *argv[])
{
    ...
    //                        "QToolButton:checked { background-color: #22c024;
    //                        color: #fff; }" "QWebView { background-color:
    //                        #fff; }");
    ////    qApp->setStyleSheet("QToolButton:checked { background-color:
    /// #191919; color: #0DD;}" /                        "QWebView {
    ...
    qApp->setStyleSheet(  //"QWidget {font-family:'Arial','Sans-Serif';
                          // font-size: 12px;}"
